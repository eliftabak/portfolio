  ...
  return (
    <Layout className="about">
      ...
      <div className="contain-sm">
        ...
        <p className="text-mdgray my-8 md:text-lg">I'm a Front-end Developer focused on building high-quality, thoughtful, and intuitive websites and web applications.</p>
        ...
        <div className="max-w-xl">
          ...
          <ul className=" flex flex-wrap md:text-lg text-mdgray">
            ...
            <li className="w-1/3 p-4">
              <div>
                <img src={require('../images/Favorites/jquery.png')} className="logo" alt="logo-img" />
                <span>jQuery</span>
              </div>
            </li>
            <li className="w-1/3 p-4">
