...
const Projects = () => {
  const query = useStaticQuery(graphql`
    query {
      converse: file(relativePath: { eq: "converse1.png" }) {
        childImageSharp {
      ...
      loccitane: file(relativePath: { eq: "loccitane.png" }) {
        childImageSharp {
          fluid(maxWidth: 1000, quality: 100) {
            ...GatsbyImageSharpFluid
          }
  ...
  return (
    <div>
      <div className="bg-pink-200 mb-12 relative overflow-hidden rounded transform transition duration-150 ease-in-out hover:scale-105 shadow-inner">
        <div className="md:w-7/12 lg:w-6/12 p-10 md:p-24">
          <h3 className="text-xl md:text-3xl">Converse</h3>
          <p className="text-mdgray my-4">Interactive webpage template that Converse can use to manage and edit content via Akinon's custom CMS.</p>
          <ul className="flex mb-4 text-mdgray text-sm">
            <li className="mr-4">JavaScript</li>
            <li className="mr-4">Jinja</li>
            <li>Bootstrap</li>
          </ul>
          <div className="flex">
            <a href="https://youtu.be/0I2QbagL91k" target="_blank" rel="noopener noreferrer">
        ...
        <div className="hidden md:block absolute bottom-0 right-0 md:w-8/12 lg:w-7/12 h-62 sm:-mb-16 md:-mr-40 lg:-mb-16 lg:-mr-20">
          <Img fluid={query.converse.childImageSharp.fluid} />
        </div>
      </div>
      <div className="bg-orange-200 mb-12 relative overflow-hidden rounded transform transition duration-150 ease-in-out hover:scale-105 shadow-inner">
        <div className="md:w-7/12 lg:w-6/12 p-10 md:p-24">
          <h3 className="text-xl md:text-3xl">L&#39;Occitane en Provence</h3>
          <p className="text-mdgray my-4">eCommerce site for a French brand that sells everything related to bath and beauty.</p>
          <ul className="flex mb-4 text-mdgray text-sm">
            <li className="mr-4">JavaScript</li>
            <li className="mr-4">Jinja</li>
          ...
          <div className="flex">
            <a href="https://youtu.be/KWrVTW3oKbA" target="_blank" rel="noopener noreferrer">
              <svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0)" fill="#47535E">
                  <path d="M19.076.222H13.22a.924.924 0 100 1.848h3.625l-8.86 8.86a.924.924 0 001.307 1.306l8.86-8.86v3.626a.924.924 0 101.848 0V1.146a.925.925 0 00-.924-.924z" />
                  <path d="M15.296 7.925a.924.924 0 00-.924.924v9.081H1.848V5.406h9.627a.924.924 0 100-1.848H.924A.924.924 0 000 4.482v14.372a.924.924 0 00.924.924h14.372a.924.924 0 00.924-.924V8.85a.924.924 0 00-.924-.924z" />
        ...
        <div className="hidden md:block absolute bottom-0 right-0 md:w-8/12 lg:w-7/12 h-62 sm:-mb-16 md:-mr-40 lg:-mb-16 lg:-mr-20">
          <Img fluid={query.loccitane.childImageSharp.fluid} />
        </div>
      </div>
      ...
      <div className="bg-purple-200 mb-12 relative overflow-hidden rounded transform transition duration-150 ease-in-out hover:scale-105 shadow-inner">
        <div className="md:w-7/12 lg:w-6/12 p-10 md:p-24">
          ...
          <p className="text-mdgray my-4">Showcases top watched movies and actors in real-time using TMDb API.</p>
          <ul className="flex mb-4 text-mdgray text-sm">
            <li className="mr-4">JavaScript</li>
      ...
      <div className="bg-blue-200 mb-12 relative overflow-hidden rounded transform transition duration-150 ease-in-out hover:scale-105 shadow-inner">
        <div className="md:w-7/12 lg:w-6/12 p-10 md:p-24">
          ...
          <p className="text-mdgray my-4">A new modern looking UI concept for Banque Saudi Fransi mobile app.</p>
          <ul className="flex mb-4 text-mdgray text-sm">
      ...
      <div className="bg-red-200 relative overflow-hidden rounded transform transition duration-150 ease-in-out hover:scale-105 shadow-inner">
        <div className="md:w-7/12 lg:w-6/12 p-10 md:p-24">
          ...
          <p className="text-mdgray my-4">Create daily tasks by adding and deleting items, and make new lists using parameters in the address bar.</p>
          <ul className="flex mb-4 text-mdgray text-sm">
            <li className="mr-4">JavaScript</li>
